...
ProgramPair* KRGST::compare(Program* pa, Program* pb, float& cpu_phase1, float& cpu_phase2) {
	...
	vector<unsigned int>& pa_hashes			= pa->getKgramHashes();
	...
	do {
        ...
        std::chrono::high_resolution_clock::time_point phase1_start = std::chrono::high_resolution_clock::now();
        ...
        cpu_phase1 += std::chrono::duration_cast<std::chrono::microseconds>(std::chrono::high_resolution_clock::now() - phase1_start).count();
        ...
        cpu_phase2 += std::chrono::duration_cast<std::chrono::microseconds>(std::chrono::high_resolution_clock::now() - phase2_start).count();
