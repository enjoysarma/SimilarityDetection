...
unsigned int 	Parameters::max_token_vector_size = 0;
...
unsigned int Parameters::getMaxTokenVectorSize() {
	return max_token_vector_size;
}

void Parameters::setMaxTokenVectorSize(unsigned int maxTokenVectorSize) {
	max_token_vector_size = maxTokenVectorSize;
}
